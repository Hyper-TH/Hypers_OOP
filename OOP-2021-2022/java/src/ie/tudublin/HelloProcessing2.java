...
public class HelloProcessing2 extends PApplet 
{
	...
	{	
		...
		// DEFAULT, interpret first 2 params as upper-left corner
		// Last two params are width and height
		// rectMode(CORNER)
		
		// Interpret first 2 params as location of one corner
		// Last two params location of opposite corner
		// rectMode(CORNERS)

		// Interpret first 2 params as shape's center
		// Last two params are width and height
		// rectMode(CENTER)

		// Interprest first 2 as shape's center
